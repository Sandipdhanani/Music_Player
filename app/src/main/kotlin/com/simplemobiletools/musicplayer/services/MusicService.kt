package com.exmple.musicplayer.services
...
import com.exmple.musicplayer.receivers.ControlActionsListener
import com.exmple.musicplayer.receivers.HeadsetPlugReceiver
import com.exmple.musicplayer.receivers.NotificationDismissedReceiver
...
class MusicService : Service(), MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, OnAudioFocusChangeListener {
    ...
    private fun getContentIntent(): PendingIntent {
        val contentIntent = Intent(this, com.exmple.musicplayer.activities.MainActivity::class.java)
