...
import com.exmple.musicplayer.BuildConfig
...
import com.exmple.musicplayer.dialogs.EditDialog
import com.exmple.musicplayer.extensions.config
import com.exmple.musicplayer.extensions.sendIntent
import com.exmple.musicplayer.extensions.songsDAO
import com.exmple.musicplayer.helpers.*
import com.exmple.musicplayer.interfaces.SongListListener
...
class SongAdapter(activity: SimpleActivity, var songs: ArrayList<Song>, val listener: SongListListener, val transparentView: View,
    ...
    private var transparentViewHolder: com.exmple.musicplayer.adapters.SongAdapter.TransparentViewHolder? = null
    private var transparentViewHeight = 0

    private var navigationView: ViewGroup? = null
    private var navigationViewHolder: com.exmple.musicplayer.adapters.SongAdapter.NavigationViewHolder? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        if (holder !is com.exmple.musicplayer.adapters.SongAdapter.TransparentViewHolder && holder !is com.exmple.musicplayer.adapters.SongAdapter.NavigationViewHolder) {
    ...
    private fun getTransparentViewHolder(): com.exmple.musicplayer.adapters.SongAdapter.TransparentViewHolder {
    ...
    private fun getNavigationViewHolder(): com.exmple.musicplayer.adapters.SongAdapter.NavigationViewHolder {
