package com.exmple.musicplayer.fragments
...
import com.exmple.musicplayer.extensions.getActionBarHeight
import com.exmple.musicplayer.extensions.sendIntent
import com.exmple.musicplayer.helpers.*
import com.exmple.musicplayer.inlines.indexOfFirstOrNull
...
class SongsFragment(context: Context, attributeSet: AttributeSet) : MyViewPagerFragment(context, attributeSet), SongListListener {
    ...
    private lateinit var activity: com.exmple.musicplayer.activities.SimpleActivity
    ...
    fun setupFragment(simpleActivity: com.exmple.musicplayer.activities.SimpleActivity) {
        storeStateVariables()
    ...
    fun fillSongsListView(songs: ArrayList<Song>) {
        ...
        if (currAdapter == null) {
            com.exmple.musicplayer.adapters.SongAdapter(activity, songs, this, artView!!, songs_list, songs_fastscroller) {
            ...
            (currAdapter as com.exmple.musicplayer.adapters.SongAdapter).apply {
                isThirdPartyIntent = activityInterface.getIsThirdPartyIntent()
                updateSongs(songs)
            }
    ...
    fun getSongsAdapter() = songs_list.adapter as? com.exmple.musicplayer.adapters.SongAdapter
